...
const buttonName = document.querySelector('.auto-play-button');

if(buttonName.innerText === 'Auto Play'){buttonName.innerHTML = 'Stop';
buttonName.classList.add('stopButton')


}else {
  buttonName.innerHTML = 'Auto Play';
  buttonName.classList.remove('stopButton')
}
} 
